        ...
        if page_num in page_teams:
            ...
            if team1_lower in case_map:
                ...
                if len(players) > MAX_PLAYERS_PER_TEAM:
                    print(f"WARNING: {team1_name} ({team1_class}) has {len(players)} players (max {MAX_PLAYERS_PER_TEAM}). Skipping this team.")
            ...
            if team2_lower in case_map:
                ...
                if len(players) > MAX_PLAYERS_PER_TEAM:
                    print(f"WARNING: {team2_name} ({team2_class}) has {len(players)} players (max {MAX_PLAYERS_PER_TEAM}). Skipping this team.")
